  ...
  <?php
       ...
       $background_style =  get_option(THEME_NAME_S.'_background_style','Pattern');
			...
			if(!empty($background_id)){ 
				...
				echo ' body{ background: url("'.$background_image[0] . '")};';
			}
		}
       ...
       $background_pattern = get_option(THEME_NAME_S.'_background_pattern','1');
		?>
		body{
			background: url('<?php echo CP_PATH_URL; ?>/images/pattern/pattern-<?php echo $background_pattern; ?>.png');
...
/* Font Size
   ------------------------------------------------------------------ */
body{
	font-size: <?php echo get_option(THEME_NAME_S.'_content_size', '12'); ?>px !important;
}
h1{
	font-size: <?php echo get_option(THEME_NAME_S.'_h1_size', '30'); ?>px !important;
}
h2{
	font-size: <?php echo get_option(THEME_NAME_S.'_h2_size', '25'); ?>px !important;
}
h3{
	font-size: <?php echo get_option(THEME_NAME_S.'_h3_size', '20'); ?>px !important;
}
h4{
	font-size: <?php echo get_option(THEME_NAME_S.'_h4_size', '18'); ?>px !important;
}
h5{
	font-size: <?php echo get_option(THEME_NAME_S.'_h5_size', '16'); ?>px !important;
}
h6{
	font-size: <?php echo get_option(THEME_NAME_S.'_h6_size', '15'); ?>px !important;
}
