...
var random_class;
    ...
    jQuery('input:button.upload_image_button_meta').click(function(e) {

       e.preventDefault();

random_class=Math.floor((Math.random() * 400) + 1);

attachment_id = jQuery(this).siblings("#upload_image_attachment_id");

upload_field = jQuery(this).siblings("#upload_image_text_meta");
