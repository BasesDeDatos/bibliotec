...
<a class="cartplus-contents" href="<?php echo $woocommerce->cart->get_cart_url(); ?>" onclick="javascript: return false;" title="<?php _e('View your shopping cart', 'crunchpress'); ?>"><?php echo sprintf(_n('%d '.$translation_cart_item, '%d '.$translation_cart_item, $woocommerce->cart->cart_contents_count, 'book-store'), $woocommerce->cart->cart_contents_count);?> - <?php echo $woocommerce->cart->get_cart_total(); ?></a>
<?php
...
class WooCommerce_Widget_CartPlus extends WP_Widget {
	...
	function WooCommerce_Widget_CartPlus() {
		...
		parent::__construct( 'shopping_cartplus', $this->woo_widget_name, $widget_ops );
...
?>
  ...
  <a class="cartplus-contents" href="<?php echo $woocommerce->cart->get_cart_url(); ?>" onclick="javscript: return false;" title="<?php _e('View your shopping cart', 'book-store'); ?>"><?php echo sprintf(_n('%d ' .$translation_cart_item, '%d '.$translation_cart_item, $woocommerce->cart->cart_contents_count, 'book-store'), $woocommerce->cart->cart_contents_count);?> - <?php echo $woocommerce->cart->get_cart_total(); ?></a> </div>
