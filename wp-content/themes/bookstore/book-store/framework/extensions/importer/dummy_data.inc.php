<?php
     ...
     */          
			...
			'sidebar-footer-3' => array ( 0 => 'book-store_widget'),
			'array_version' => 3 , );
		    ...
		    save_option('widget_book-store_widget',get_option('widget_book-store_widget'), array ( 'title' => 'From the blog', 'limit' => '5', 'cat' => '0', 'post_type' => 'post' )  );	
