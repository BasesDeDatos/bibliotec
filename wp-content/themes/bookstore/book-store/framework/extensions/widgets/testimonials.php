...
class Testimonials extends WP_Widget {
	...
	function Testimonials() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'testimonial-widget', 'description' => __('A widget that show last portfolio', 'book-store') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'testimonial-widget' );

		/* Create the widget. */
		parent::__construct( 'testimonial-widget', __('Testimonials', 'book-store'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' => __('Testimonials', 'book-store'), 'port_cat' => __('All', 'book-store'), 'show_num' => '3');
		$instance = wp_parse_args( (array) $instance, $defaults ); ?>

		<!-- Widget Title: Text Input -->
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e('Title :', 'book-store'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'port_cat' ); ?>"><?php _e('Category :', 'book-store'); ?></label>		
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'show_num' ); ?>"><?php _e('Show Count :', 'book-store'); ?></label>
